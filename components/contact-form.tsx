...
const copy = {
  hu: {
    ...
    services: ['Új weboldal készítés', 'Meglévő weboldal fejlesztése', 'Top 3 helyezés a Google Térképen 90 napon belül / Google Cégprofil', 'Nem tudom, konzultációt kérek'],

...
const copy = {
  hu: {
    label: 'Kalkulátor', title: 'Google Térkép megtérülési kalkulátor', intro: 'Becsülje meg, hogy a jobb Google Térkép-helyezés mennyi hívást és munkát hozhat reálisan.', business: 'Válassza ki, mivel foglalkozik a vállalkozása.', city: 'Adja meg, mekkora településen dolgozik leggyakrabban.', conversion: 'Adja meg, átlagosan hány telefonhívásból lesz valódi megrendelés.', value: 'Adja meg, mennyit keres egy átlagos munkával.', calls: 'Becsült extra hívások / hó', jobs: 'Becsült extra munkák / hó', revenue: 'Becsült extra árbevétel / hó', note: 'Ez becslés, nem garantált eredmény.', cta: 'Kérek pontos ajánlatot', placeholder: 'Válassz', currency: (n: number) => new Intl.NumberFormat('hu-HU').format(Math.round(n)) + ' Ft', number: (n: number) => new Intl.NumberFormat('hu-HU', { maximumFractionDigits: 1 }).format(n),
  },
  en: {
